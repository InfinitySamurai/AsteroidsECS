...
public class BulletFactory {
    VisualComponent bulletVisual = new VisualComponent(new TextureRegion(new Texture("bullet.png")));
    ...
    public Entity createBullet(float x, float y, float rotation, float speed, float offsetDistance) {
        ...
        bullet.add(new HitCircleComponent(position, bulletVisual.width / 2));
